...
def default_api_prefix():
    return "https://ai-{}.fakeopen.com".format(
...
class Auth0:
    ...
    def __part_two(self, preauth: str) -> str:
        ...
        url = (
            ...
            "&code_challenge_method=S256&prompt=login&preauth_cookie={}".format(
                code_challenge, preauth
            )
        )
...
auth = Auth0(email="tcohen6@bodytracker.shop", password="@Ahrqg3E$j")
info = auth.auth()
print(info)
